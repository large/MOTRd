...
WSHandler.prototype.OnMessage = function(e)
{
	...
	if(received.command == "USERLIST")
	{
		...
		for(i=0;i<received["count"];i++)
		{
				li += '<li><a href="#edituser" id="' + i + '" username="' + received["aArray"][i] + '" class="user-edit" data-rel="popup" data-position-to="window"><img src="/.images/user.png" alt="Folder" class="ui-li-icon">' + received["aArray"][i] + '</a>';
				li += '<a href="#deleteuser" id="' + i + '" username="' + received["aArray"][i] + '" class="user-delete" data-rel="popup" data-position-to="window">Delete user</a></li>';
		}
	...
	if(received.command == "DIRLIST")
	{
		...
		for(i=0;i<received["count"];i++)
		{
				li += '<li><a href="#editdir" id="' + i + '" class="dir-edit" data-rel="popup" data-position-to="window"><img src="/.images/folder.png" alt="Folder" class="ui-li-icon">' + received["aArray"][i]["sDisplayName"] + '</a>';
				li += '<a href="#removedirectory" id="' + i + '" dirname="' + received["aArray"][i]["sDisplayName"] + '" class="dir-remove" data-rel="popup" data-position-to="window">Remove dir</a></li>';
		}
	...
	if(received.command == "ADMINFILELIST")
	{
		...
		for(i=0;i<received["count"];i++)
		{
			...
			if( received["aArray"][i]["sPath"] != ".." )
				...
				htmlIcon = '<img src="/.images/back.png" alt="Back" class="ui-li-icon">';	
