...
WSHandler.prototype.OnMessage = function(e)
{
	...
	if(received.command == "AVAILABLEDIRS")
	{
		...
		for(i=0;i<received["count"];i++)
			li += '<li><a href="#" id="' + i + '" class="drive-select"><img src="/.images/folder.png" alt="Folder" class="ui-li-icon">' + received["aArray"][i]["sDisplayName"] + '</a></li>';		
	...
	//Here we did not receive anything, therefor it replied with the same command
	...
	if(received.command == "FILELIST")
	{
		...
		for(i=0;i<received["count"];i++)
			if(received["aArray"][i]["bIsFolder"] == true)
				li += '<li><a href="#" id="' + i + '" class="file-select"><img src="/.images/folder.png" alt="Folder" class="ui-li-icon">' + received["aArray"][i]["sDisplayName"] + '</a></li>';		
			else
				li += '<li><a href="#" id="' + i + '" class="file-select">' + received["aArray"][i]["sDisplayName"] + '<span class="ui-li-count">' + received["aArray"][i]["sFileSize"] + '</span></a></li>';
