...
namespace WebSockets.Client
{
    public class WebSocketClient : WebSocketBase, IDisposable
    {
        ...
        protected override void PerformHandshake(Stream stream)
        {
            ...
            _logger.Debug(this.GetType(), "Handshake sent. Waiting for response.");
            ...
            {
                _logger.Debug(this.GetType(), "Handshake response received. Connection upgraded to WebSocket protocol.");
            }
        }
        ...
        public virtual void Dispose()
        {
            if (_isOpen)
            {
                using (MemoryStream stream = new MemoryStream())
                {
                    ...
                    _logger.Debug(this.GetType(), "Sent websocket close message to server. Reason: GoingAway");
                }
        ...
        private void WaitForServerCloseMessage()
        {
            ...
            _logger.Debug(this.GetType(), "Client: Connection closed");
        }
